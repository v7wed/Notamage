...
const ConfirmDialog = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-[#f5edd8] border-2 border-[#c9b896] rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden animate-in zoom-in-95 fade-in duration-200">
        ...
        <div className="p-6">
          ...
          <div className="flex justify-center mb-4">
            <div className={`p-4 rounded-full border-2 ${
              ...
              <AlertTriangle className={`size-8 ${
                confirmVariant === "danger" ? "text-amber-600" : "text-blue-600"
              }`} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              onClick={onConfirm}
              className={`btn w-full py-3 border-2 font-medieval text-base font-bold rounded-lg flex items-center justify-center gap-2 transition-all shadow-sm ${
                confirmVariant === "danger"
                  ? "bg-red-50 hover:bg-red-100 border-red-300 text-red-700"
                  : "bg-[#d9c5a0] hover:bg-[#e3d2ae] border-[#c9b896] text-[#5c4a2a]"
              }`}
            >
